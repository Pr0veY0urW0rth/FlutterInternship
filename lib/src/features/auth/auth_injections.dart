...
import 'package:intership/src/features/auth/data/repositories/auth_remote_repository_impl.dart';
...
initAuthInjections() {
  ...
  sl.registerSingleton<AuthRemoteRepository>(AuthRemoteRepositoryImpl(sl()));
